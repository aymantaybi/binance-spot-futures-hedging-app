...
export const GetGreetingsDocument = gql`
    query GetGreetings($name: String) {
  greetings(name: $name)
}
    `;
 ...
 * });
 */
export function useGetGreetingsQuery(baseOptions?: Apollo.QueryHookOptions<GetGreetingsQuery, GetGreetingsQueryVariables>) {
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  greetings?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, Partial<QueryGreetingsArgs>>;
};
